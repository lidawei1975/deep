 ...
 * This one has weight for each data point.
*/
struct Voigt_functor_shape_width_w: public Voigt_functor_shape_base
{
    Voigt_functor_shape_width_w(std::vector<double> height,  std::vector<double> ppm,  std::vector<double> sigma,  std::vector<double> gamma,
                          std::vector<double> spectrum_, std::vector<double> spectrum_ppm_, std::vector<double> spectrum_weight_,std::vector<double> v_total_);
    ~Voigt_functor_shape_width_w();
