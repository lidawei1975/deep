...
my $exe = "./voigt_fit_omp -method voigt -in plane001.ft2 plane002.ft2 plane003.ft2 -peak_in fitted.tab -out fitted3.tab -recon no -noise_level 233038.28125 -scale 18.5625 -scale2 11.1375";
...
open(IN, "fitted3.tab" ) or die "Cannot open fitted.tab\n";
